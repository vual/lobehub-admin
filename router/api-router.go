...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		// LobeHub route
		lobeHubUserRoute := apiRouter.Group("/lobehub/users")
		lobeHubUserRoute.Use(middleware.AdminAuth())
		{
			lobeHubUserRoute.GET("", controller.ListLobeHubUsers)
			lobeHubUserRoute.GET("/:id", controller.GetLobeHubUser)
			lobeHubUserRoute.PATCH("/:id", controller.UpdateLobeHubUser)
			lobeHubUserRoute.POST("/:id/ban", controller.BanLobeHubUser)
			lobeHubUserRoute.POST("/:id/unban", controller.UnbanLobeHubUser)
